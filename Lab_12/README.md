...
- отсутствует связность между компьютерами сотрудников Питерского офиса и внешним миром. Исправим это, всключив MPLS по протоколу LDP на маршрутизаторах ядра глобально и на конкретных интерфейсах. На примере SW9:
...
- Проверим связность между филиалами с настроенными BGP free core
