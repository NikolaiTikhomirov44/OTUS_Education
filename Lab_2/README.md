...
- Проверяем отработку механизма при недоступности и восстановлении шлюза (для провекрки гасим порт e0/3 на R25)

![alt text](image-20.png)

# 4. Настройка маршрута по умолчанию для офиса Лабытнанги

- Для офиса в Лабытнанги настроим полностью заданный маршрут по умолчанию
