...
- На маршрутизаторе R14 настроим prefix-list с разрешенным маршрутом по умолчанию и повесим его на провайдера Киторн
...
- В исходном состоянии мы имеем два идентичных линка c разными хопами между офисом в Санкт-петербурге и провайдером Триада
